...
mixin TypeChannelMessageDispatcher {
  ...
  void sendCreateNewInstancePair(
    String channelName,
    Object instance,
    List<Object?> arguments,
  );
...
abstract class TypeChannelMessenger {
  ...
  /// Sends a message to another [TypeChannelMessenger] with
  /// [messageDispatcher].
  void createNewInstancePair(String channelName, Object instance) {
    ...
    messageDispatcher.sendCreateNewInstancePair(
      channelName,
      instance,
  ...
  //   List<Object?> arguments,
  // ) async {
  //   return messageDispatcher.sendInvokeStaticMethod(
  //     channelName,
  //     methodName,
  ...
  //   }
  //
  //   return messageDispatcher.sendInvokeMethod(
  //     channelName,
