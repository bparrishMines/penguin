#flutter pub run reference_generator --no-build --branch master --dart-out lib/src/avfoundation.g.dart --dart-imports 'dart:typed_data' lib/src/avfoundation.dart
