...
- (id)_capturePhoto:(NSObject<_IAFCapturePhotoSettings>*_Nullable)settings
...
- (id)_addInput:(NSObject<_IAFCaptureInput>*_Nullable)input;

- (id)_addOutput:(NSObject<_IAFCaptureOutput>*_Nullable)output;
