import 'channel.dart';import 'banana.dart';import 'apple.dart';class Basket {Basket() { Channel.channel.invokeMethod<void>('Basket()', <String, dynamic>{'basketHandle': handle}); }
...
class _AppleImpl extends Apple { }
