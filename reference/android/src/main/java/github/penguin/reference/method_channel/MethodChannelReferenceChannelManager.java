...
public class MethodChannelReferenceChannelManager extends ReferenceChannelManager {
  ...
  public MethodChannelReferenceChannelManager(final BinaryMessenger binaryMessenger, final String channelName) {
    ...
    channel.setMethodCallHandler(new MethodChannel.MethodCallHandler() {
      @Override
      public void onMethodCall(@NonNull MethodCall call, @NonNull MethodChannel.Result callResult) {
        try {
          switch (call.method) {
            case METHOD_CREATE:
            {
            ...
            case METHOD_DISPOSE:
              final List<Object> arguments = (List<Object>) call.arguments;
              onReceiveDisposePair((String) arguments.get(0), (RemoteReference) arguments.get(1));
              callResult.success(null);
              break;
            default:
