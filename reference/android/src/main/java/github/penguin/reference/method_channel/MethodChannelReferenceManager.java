...
public abstract class MethodChannelReferenceManager extends ReferenceManager
    implements ReferenceManager.LocalReferenceHandler {
  ...
  private static class MethodChannelRemoteReferenceHandler implements RemoteReferenceHandler {
    ...
    private MethodChannelRemoteReferenceHandler(
    ...
    public <T> CompletableRunnable<T> sendRemoteMethodCall(
      ...
      final CompletableRunnable<T> completer =
          new CompletableRunnable<T>() {
            @Override
            public void run() {
              channel.invokeMethod(
                  ...
                  new MethodChannel.Result() {
                    ...
                    public void error(String errorCode, String errorMessage, Object errorDetails) {
                      completeWithError(
                          new Exception(String.format("%s: %s", errorCode, errorMessage)));
                    }
  ...
  public MethodChannelReferenceManager(
