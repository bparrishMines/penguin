...
void main() {
  ...
  group('$ReferencePairManager', () {
      ...
      expect(methodCallLog, <Matcher>[
        isMethodCallWithMatchers('REFERENCE_CREATE', arguments: <dynamic>[
          ...
          <dynamic>[
            ...
            <String, Matcher>{
              'fire': isUnpairedRemoteReference(
                TypeReference(0),
      ...
      expect(methodCallLog, <Matcher>[
        isMethodCallWithMatchers('REFERENCE_METHOD', arguments: <dynamic>[
          ...
          <dynamic>[
            ...
            <String, Matcher>{
              'pickle': isUnpairedRemoteReference(
                TypeReference(0),
    ...
    test('executeRemoteMethodFor returnsReference', () async {
      ...
      expect(result, isClassTemplate(44, null, null, null));
    });
    ...
    test('createLocalReferenceFor', () async {
      ...
      expect(
        ...
        isClassTemplate(
          ...
          isClassTemplate(
            9,
            isClassTemplate(14, null, null, null),
            null,
            null,
          ),
          <Matcher>[isClassTemplate(10, null, null, null)],
          <String, Matcher>{
            'ohno': isClassTemplate(13, null, null, null)
          },
        ),
      );
    });
    ...
    test('executeLocalMethodFor', () async {
      ...
      expect(
        ...
        completion(
          <dynamic>[
            'Apple',
            isClassTemplate(19, null, null, null),
            <Matcher>[isClassTemplate(62, null, null, null)],
            <String, Matcher>{
              'poyo': isClassTemplate(11, null, null, null),
            }
          ],
        ),
      );
    ...
    test('disposeLocalReference', () async {
      ...
      expect(testClass, isClassTemplate(45, null, null, null));
